  ...
  const incidents: Incident[] = [
    {
      date: '2026-03-23',
      type: 'Aviation',
      location: 'Near Puerto Leguízamo, Colombia',
      company: 'Colombian Air Force — C-130 Hercules',
      description: 'C-130 Hercules transport crashed near Puerto Leguízamo; approximately 70 of 126 aboard killed',
      casualties: '~70 fatalities',
      investigation: 'Ongoing',
      findings: 'Military transport crash; details under investigation',
      pattern: false,
      sources: ['https://en.wikipedia.org/wiki/2026_Colombian_Air_Force_crash'],
    },
    {
      date: '2026-03-22',
      type: 'Aviation',
      location: 'LaGuardia Airport, New York',
      company: 'Air Canada Express / Jazz Aviation — CRJ-900 Flight 8646',
      description: 'CRJ-900 collided with ARFF fire truck on landing; both pilots killed; dozens injured',
      casualties: '2 fatalities (both pilots)',
      investigation: 'Ongoing (NTSB)',
      findings: 'First fatal LaGuardia accident in 34 years; collision with emergency response vehicle on runway',
      pattern: true,
      patternNote: 'Rare but serious ground collision incident at major airport',
      sources: ['https://en.wikipedia.org/wiki/2026_LaGuardia_airport_collision'],
    },
    {
      date: '2026-02-23',
      type: 'Aviation',
      location: 'Simaria, Jharkhand, India',
      company: 'Beechcraft Air Ambulance',
      description: 'Medical air ambulance crashed with all 7 aboard killed',
      casualties: '7 fatalities',
      investigation: 'Ongoing',
      findings: 'Air ambulance crash; details under investigation',
      pattern: false,
      sources: ['https://en.wikipedia.org/wiki/2026_Simaria_air_ambulance_crash'],
    },
    {
      date: '2026-01-28',
      type: 'Aviation',
      location: 'Baramati, Maharashtra, India',
      company: 'Learjet 45XR',
      description: 'Business jet crashed in Baramati',
      casualties: 'Multiple fatalities',
      investigation: 'Ongoing',
      findings: 'Learjet crash; details under investigation',
      pattern: false,
      sources: ['https://en.wikipedia.org/wiki/2026_Baramati_Learjet_crash'],
    },
    {
      date: '2026-01-25',
      type: 'Aviation',
      location: 'Bangor, Maine',
      company: 'Bombardier Challenger 650 — Business Jet',
      description: 'Business jet crashed on takeoff; 6 passengers from Houston law firm killed',
      casualties: '6 fatalities',
      investigation: 'Ongoing (NTSB)',
      findings: 'Takeoff crash; legal team from Houston killed',
      pattern: false,
      sources: ['https://en.wikipedia.org/wiki/2026_Bangor_business_jet_crash'],
    },
    {
      date: '2026-01-17',
      type: 'Aviation',
      location: 'Sulawesi, Indonesia',
      company: 'Indonesia Air Transport — ATR 42-512',
      description: 'Government marine-surveillance flight crashed with all 10 aboard killed',
      casualties: '10 fatalities',
      investigation: 'Ongoing',
      findings: 'Surveillance flight crash; details under investigation',
      pattern: false,
      sources: ['https://en.wikipedia.org/wiki/2026_Indonesia_Air_Transport_crash'],
    },
    {
      date: '2025-12-15',
      type: 'Aviation',
      location: 'Toluca, Mexico',
      company: 'Cessna 650 Citation III',
      description: 'Citation III business jet crashed with 10 aboard killed',
      casualties: '10 fatalities',
      investigation: 'Ongoing',
      findings: 'Business jet crash; details under investigation',
      pattern: false,
      sources: ['https://en.wikipedia.org/wiki/2025_Toluca_Citation_crash'],
    },
    {
      date: '2025-11-11',
      type: 'Aviation',
      location: 'Near Sighnaghi, Georgia',
      company: 'Turkish Air Force — C-130EM Hercules',
      description: 'Turkish military transport crashed near Sighnaghi; 20 killed',
      casualties: '20 fatalities',
      investigation: 'Ongoing',
      findings: 'Military transport crash; details under investigation',
      pattern: false,
      sources: ['https://en.wikipedia.org/wiki/2025_Turkish_Air_Force_Hercules_crash'],
    },
    {
      date: '2025-07-24',
      type: 'Aviation',
      location: 'Tynda, Russia',
      company: 'Angara Airlines — Antonov An-24RV',
      description: 'Regional transport crashed with 48 aboard killed',
      casualties: '48 fatalities',
      investigation: 'Ongoing',
      findings: 'Regional aircraft crash; details under investigation',
      pattern: false,
      sources: ['https://en.wikipedia.org/wiki/2025_Tynda_Antonov_crash'],
    },
    {
      date: '2025-06-12',
      type: 'Aviation',
      location: 'Ahmedabad, India',
      company: 'Air India — Boeing 787-8 Dreamliner Flight 171',
      description: 'Boeing 787-8 Dreamliner crashed seconds after takeoff from Ahmedabad; 241 onboard + 19 on ground killed',
      casualties: '~260 fatalities',
      investigation: 'Ongoing',
      findings: 'First fatal Boeing 787 hull loss; electrical and FADEC system questions remain',
      pattern: true,
      patternNote: 'First fatal 787 accident; questions raised about electrical and engine control systems',
      sources: ['https://en.wikipedia.org/wiki/2025_Air_India_Dreamliner_crash'],
    },
    {
      date: '2025-05-01',
      type: 'Aviation',
      location: 'San Diego, California',
      company: 'Cessna Citation II',
      description: 'Citation II business jet crashed with 6 aboard killed (music-industry group)',
      casualties: '6 fatalities',
      investigation: 'Ongoing',
      findings: 'Business jet crash involving music industry personnel',
      pattern: false,
      sources: ['https://en.wikipedia.org/wiki/2025_San_Diego_Citation_crash'],
    },
    {
      date: '2025-04-01',
      type: 'Aviation',
      location: 'Hudson River, New York City',
      company: 'Bell 206 Helicopter',
      description: 'Helicopter crashed into Hudson River; pilot and 5 passengers killed',
      casualties: '6 fatalities',
      investigation: 'Ongoing (NTSB)',
      findings: 'Helicopter crash in Hudson River',
      pattern: false,
      sources: ['https://en.wikipedia.org/wiki/2025_Hudson_River_helicopter_crash'],
    },
    {
      date: '2025-02-01',
      type: 'Aviation',
      location: 'Toronto Pearson International Airport, Canada',
      company: 'Delta Connection — CRJ-900 Flight 4819',
      description: 'CRJ-900 hard landing and flip; first fatal hull-loss incident of the CRJ-900 type',
      casualties: 'Multiple fatalities',
      investigation: 'Ongoing (TSB)',
      findings: 'First fatal CRJ-900 hull loss; hard landing resulted in flip',
      pattern: false,
      sources: ['https://en.wikipedia.org/wiki/2025_Toronto_CRJ_accident'],
    },
    {
      date: '2025-02-01',
      type: 'Aviation',
      location: 'Western Alaska',
      company: 'Bering Air — Flight 445',
      description: 'Commuter aircraft crashed in western Alaska; all 10 aboard killed',
      casualties: '10 fatalities',
      investigation: 'Ongoing (NTSB)',
      findings: 'One of Alaska\'s deadliest in 25 years; icing and ATC instructions under scrutiny',
      pattern: false,
      sources: ['https://en.wikipedia.org/wiki/2025_Bering_Air_crash'],
    },
    {
      date: '2025-01-29',
      type: 'Aviation',
      location: 'Unity oilfield airstrip, South Sudan',
      company: 'Light Air Services — Beechcraft 1900',
      description: 'Beechcraft 1900 commuter crashed; 20 of 21 aboard killed (oil workers)',
      casualties: '20 fatalities',
      investigation: 'Ongoing',
      findings: 'Remote airstrip crash with heavy casualties among oil industry workers',
      pattern: false,
      sources: ['https://en.wikipedia.org/wiki/2025_South_Sudan_Beechcraft_crash'],
    },
    {
      date: '2025-01-28',
      type: 'Aviation',
      location: 'Potomac River, Washington D.C. (Reagan National)',
      company: 'PSA Airlines / American Eagle — CRJ-700 Flight 5342 & US Army UH-60 Black Hawk',
      description: 'Mid-air collision between regional jet and Army Black Hawk helicopter on final approach; all 67 aboard both aircraft killed',
      casualties: '67 fatalities',
      investigation: 'Ongoing (NTSB)',
      findings: 'Deadliest U.S. commercial crash in 16+ years; NTSB cited FAA airspace design issues and ATC workload as contributing factors',
      pattern: true,
      patternNote: 'Deadliest commercial air accident since 2009; raises serious questions about Reagan National airspace design and controller workload',
      sources: ['https://en.wikipedia.org/wiki/2025_Potomac_River_collision', 'https://www.ntsb.gov'],
    },
    {
      date: '2024-03-26',
      type: 'Infrastructure',
